#' @title Get the basic information of different football teams from England
#'
...
#' @return the basic information of football teams, including country, home, city and fundation time
#'
#' @examples
