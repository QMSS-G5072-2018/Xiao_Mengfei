...
male_top10 <- select(arrange(dataset_2016, desc(binge_male)), 
                     "year", "state", "binge_male")[1:10,]
female_top10 <- select(arrange(dataset_2016, desc(binge_female)), 
                       "state", "binge_female")[1:10,]
overall_top10 <- select(arrange(dataset_2016, desc(binge_all)), 
                        "state", "binge_all")[1:10,]
result_top10 <- data.frame(Male = male_top10,
                           Female = female_top10,
                           Overall = overall_top10)
names(result_top10) <- c("year", "state", "Male", "state", "Female", 
                         "state", "Overall" )
```
